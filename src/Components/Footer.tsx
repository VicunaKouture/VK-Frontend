      ...
      <div className="flex flex-row h-[70%] items-center ">
        ...
        <div className="w-[25%]  flex h-[80%] flex-col">
          ...
          <div className="flex flex-row justify-start mt-2">
           <Link href={"www.google.com"}> <div className="pr-5"><Image src={"/Images/facebook.png"} alt={"I"} height={32} width={32}/></div></Link>
           <Link href={"www.google.com"}> <div className="px-5"><Image src={"/Images/twitter.png"} alt={"I"} height={32} width={32}/></div></Link>
           <Link href={"www.google.com"}> <div className="pl-5"><Image src={"/Images/instagram.png"} alt={"I"} height={32} width={32}/></div></Link>
          </div>
